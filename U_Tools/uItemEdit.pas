...
uses
  ...
  Grids, Resources, ComCtrls, StdCtrls, DataStructs,
  Math, Spin, Buttons, uGameSubs, ToolWin, uInterface, ExtCtrls,
  MyStrings;
...
type
  TItemEditForm = class(TForm)
    ...
    Label25: TLabel;
    eMProdSpell: TSpinEdit;
    Label26: TLabel;
    cmMagMaterial: TComboBox;
    eHampBonus: TSpinEdit;
    Label29: TLabel;
    Label30: TLabel;
    Label31: TLabel;
    eMountBonus: TSpinEdit;
    cbLong: TCheckBox;
    cbShort: TCheckBox;
    cbNoFoot: TCheckBox;
    cbNoMount: TCheckBox;
    ...
    Label14: TLabel;
    Label33: TLabel;
    eNumAttacks: TSpinEdit;
    eNumRounds: TSpinEdit;
    cmWpnClass: TComboBox;
    cbNumPlusSkill: TCheckBox;
    cbNumPlusHalf: TCheckBox;
    GroupBox3: TGroupBox;
    Label19: TLabel;
    eArmPiercing: TSpinEdit;
    Label17: TLabel;
    eArmSlashing: TSpinEdit;
    eArmCrushing: TSpinEdit;
    Label18: TLabel;
    eArmCleaving: TSpinEdit;
    Label20: TLabel;
    Label35: TLabel;
    Label36: TLabel;
    Label37: TLabel;
    Label38: TLabel;
    eArmAPiercing: TSpinEdit;
    eArmEnergy: TSpinEdit;
    eArmSpirit: TSpinEdit;
    eArmWeather: TSpinEdit;
    Label39: TLabel;
    Label40: TLabel;
    Label41: TLabel;
    Label42: TLabel;
    ...
    Label47: TLabel;
    eMonAtk: TSpinEdit;
    eMonTactics: TSpinEdit;
    eMonNumAtk: TSpinEdit;
    eMonHits: TSpinEdit;
    eMonRegen: TSpinEdit;
    Label48: TLabel;
    Label49: TLabel;
    ...
    Label57: TLabel;
    eMonMelee: TSpinEdit;
    eMonEnergy: TSpinEdit;
    eMonSpirit: TSpinEdit;
    eMonWeather: TSpinEdit;
    eMonRiding: TSpinEdit;
    eMonRanged: TSpinEdit;
    ...
    eMonObservation: TSpinEdit;
    eMonStealth: TSpinEdit;
    Label27: TLabel;
    Label28: TLabel;
    ToolBar3: TToolBar;
    ...
    eHitchWalk: TSpinEdit;
    Label34: TLabel;
    Label58: TLabel;
    cbAnyOf: TCheckBox;
    gManSkills: TStringGrid;
    ToolBar5: TToolBar;
    btnAddSpecSkill: TToolButton;
    btnDelSpecSkill: TToolButton;
    Label11: TLabel;
    cmProdTool: TComboBox;
    eProdToolBonus: TSpinEdit;
    gMaterials: TStringGrid;
    Label1: TLabel;
    gMagMaterials: TStringGrid;
    Label24: TLabel;
    cmAlignment: TComboBox;
    tsByproducts: TTabSheet;
    Label60: TLabel;
    gByproducts: TStringGrid;
    ...
    tsFood: TTabSheet;
    Label63: TLabel;
    eUpkeepSilver: TSpinEdit;
    eFoodValue: TSpinEdit;
    eFoodOrder: TSpinEdit;
    Label64: TLabel;
...
begin
  // FIXME: broken
  //if Target = Sender then with TStringGrid(Sender) do begin
